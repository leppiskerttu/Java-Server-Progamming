...
a persistence unit "nikoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "niko/pom.xml":
...
artifact ("niko.war") is already built. You can build
